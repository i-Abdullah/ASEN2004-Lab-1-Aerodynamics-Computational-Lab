...
%% Plot
figure(1)
plot(i,V_Max_Range,'*-','LineWidth',1,'DisplayName',['Weight =' num2str(i)])
legend('-DynamicLegend');
xlabel(' Weight (kg) ')
ylabel('V_m_a_x Range (m/s)')
title('V_m_a_x Range Different Weight Values')
grid minor
hold on

figure(2)
plot(i,V_Max_Endurance,'*-','LineWidth',1,'DisplayName',['Weight =' num2str(i)])
legend('-DynamicLegend');
xlabel(' Weight (kg) ')
ylabel('V_m_a_x Endurance (m/s)')
title('V_m_a_x Endurance for Different Weight Values')
grid minor
hold on
