...
% This script is to see how changing the Aspect ratio of the aircraft will affect
...
plot(Alpha2D,L_D_WholeAirplane,'*-','LineWidth',1,'DisplayName',['AR =' num2str(i)])
legend('-DynamicLegend');
xlabel(' \alpha \circ ')
ylabel('L/D')
title('L/D Comparison for Different AR Values')
hold on
grid minor
